...
public class PaymentTest {
    ...
    public static void main(String[] args) throws PayException {
        ...
        CardPayment card1 = new CardPayment("11번가","Java책",17000L,"123-432-111","0070",0);
        payProcess( card1 );
        System.out.println("-------------------------------------");
        CashPayment cash1 = new CashPayment("인터파크","에어컨",2400000L,"198-32");
        payProcess( cash1 );
        System.out.println("-------------------------------------");
		...
		/*CardPayment card2 = new CardPayment("예스24","소설책",2000L,"843-12-434","1234",-2);
		payProcess( card2 );*/

        // Exception 예제 2. 문제파일의 출력 그림 참고하세요.
		CashPayment cash2 = new CashPayment("G마켓","핸드폰",0L,"999-56");
		payProcess( cash2 );
